using ExecutorEVP_PKEY_verify = ExecutorBase<bool, EVP_PKEY_verify_Mutation>;

class EVP_PKEY_verify_Executor : public ExecutorEVP_PKEY_verify {
public:
    std::optional<bool> Execute(const EVP_PKEY_verify_Mutation& mutation) override {
